This directory contains the extra files required to deploy Matatika-CE into cloud or as a server (application is accessible from outside the server deployment. Not in localhost)
